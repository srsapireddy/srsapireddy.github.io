    ...
    <div class="sch-header">
      ...
      <div>
        <div class="sch-name">Srinivas Rahul Sapireddy, PhD 
          ...
          <img src="/images/linkedin.png" alt="LinkedIn" style="width:18px; height:18px; margin-left:6px; vertical-align:middle;"><img src="/images/isu.png" alt="UMKC Logo" ;style="width:22px; height:22px;" class="logo">
        </a>
        </div>
