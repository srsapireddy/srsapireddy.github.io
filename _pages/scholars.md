    ...
    <div class="sch-header">
      ...
      <div>
        <div class="sch-name">Srinivas Rahul Sapireddy, PhD 
          ...
          <img src="/images/linkedin.png" alt="LinkedIn" style="width:25px; height:25px; margin-left:6px; vertical-align:middle;"><img src="/images/isu.png" alt="UMKC Logo" class="logo">
        </a>
        </div>
